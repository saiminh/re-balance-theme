...
function my_wp_mail_filter( $args ) {
	...
	$new_wp_mail = array(
		...
		<!--[if !mso]><img class="dark-img" src="https://re-balance.io/wp-content/themes/rebalance-wptheme/img/rebalance-logo-darkmode.png" alt="rebalance" style="display: none; width: 200px; height: 55px; border: none; font-size:12px; font-style: italic; margin-bottom: 10px;" /><!--<![endif]-->
